...
//        five_seconds_of_solve= new Timeline();
//
...
//        });
//
//        five_seconds_of_solve.setCycleCount(Timeline.INDEFINITE);
//        five_seconds_of_solve.getKeyFrames().add(frame);
//        if(five_seconds_of_solve!=null){
//            five_seconds_of_solve.stop();
//        }
//        five_seconds_of_solve.play();
//

        close_button.setVisible(true);
    }

//    private void showAlertAndGoToMainMenu() {
//        Alert alert = new Alert(Alert.AlertType.NONE);
//        alert.setTitle("Game Over");
//        alert.setContentText("By Clicking OK you will be moved to main menu");
//        ButtonType ok = new ButtonType("OK");
//        alert.getButtonTypes().setAll(ok);
//
//        final FutureTask future_task = new FutureTask(new Callable() {
//            @Override
//            public Object call() {
...
//        Platform.runLater(future_task);
//        try {
//           result = (ButtonType) future_task.get();

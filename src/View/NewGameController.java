...
public class NewGameController implements IView, Observer, Initializable {
    ...
    private void addAllCharacters() {
        ...
        characters.add("Netta Barzilai");
        characters.add("Leonel Messi");
        characters.add("Mousy");
        characters.add("Super Mario");
        characters.add("Morty");
        characters.add("Rick");
        characters.add("Angry Mugsy");
        characters.add("Crazy Ant");
        characters.add("Eran Levy");
    }
